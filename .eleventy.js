...
module.exports = function (eleventyConfig) {
  // Add Eleventy Edge Plugin
  eleventyConfig.addPlugin(EleventyEdgePlugin); 
  // Add the .env isEdge status as GlobalData
  eleventyConfig.addGlobalData("isEdge", process.env.EDGE );
  // Add the .env Home ID as GlobalData
  eleventyConfig.addGlobalData("homeId", process.env.HOME_ID );
